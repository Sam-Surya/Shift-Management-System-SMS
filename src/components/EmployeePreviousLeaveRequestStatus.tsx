...
export default function EmployeeViewPreviousLeaveRequest() {
        ...
        async function fetchEmployeeShiftChangRequestDetails() {
            try {
                ...
                if (querySnapshot.size > 0) {
                    ...
                    setemployeePrevLeaveData(docData);
                } else {
        ...
        <div>
            ...
            <div className="container mt-5">
                ...
                <div className="col-md-6">
                    <div className="card">
                        <h5 className="card-header text-center mt-auto">View Previous Leave Request</h5>
                            ...
                            {employeePrevLeaveData ? (  // Check if data is available
                                    <div>
                                        ...
                                        <p className="card-text text-center mt-auto"><b>{employeePrevLeaveData.selectedToDate}</b></p>
                                        <p className="card-text text-center mt-auto"><b>LEAVE TYPE: {employeePrevLeaveData.selectedLeaveType}</b></p>
                                        <p className="card-text text-center mt-auto"><b>DESCRIPTION: {employeePrevLeaveData.leaveDescription}</b></p>
                                        <p className="card-text text-center mt-auto"><b>STATUS: {employeePrevLeaveData.Status}</b></p>
